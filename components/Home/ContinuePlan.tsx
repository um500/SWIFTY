// ============================================
// 📁 components/home/ContinuePlan.tsx
...
const ContinuePlan = () => {
  ...
  useEffect(() => {
    client.fetch(homeSelectedToursQuery).then((data: any) => {
      setTours(data?.tours ?? []);
      setTitle(data?.title ?? "");
    });
  }, []);
          ...
          {tours.map((tour) => (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-500">{tour.days}</p>
                <p className="text-sm font-bold text-gray-900 mt-1">
                  ₹{tour.price?.toLocaleString("en-IN")}
                  <span className="text-[10px] font-normal text-gray-500"> /pp twin sharing</span>
                </p>
