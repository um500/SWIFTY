// ============================================
// 📁 components/home/CountryPromo.tsx
// Country cards — clicking navigates to /tours?country=<slug>
// ============================================
    ...
    <section className="w-full bg-[#4b5563] py-12">
      <div className="max-w-[1440px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* LEFT CARD — links to /tours (all tours) */}
          ...
          <div>
            ...
            {loading ? (
              ...
              <p className="text-gray-300 text-sm">No destinations available.</p>
            ) : (
              <div className="grid grid-cols-2 gap-3">
                {countries.map((item, i) => (
                  // ✅ FIXED: /tours?country=<slug> so the listing page filters correctly
                  <Link
                    key={item?._id ?? i}
                    href={`/tours?country=${item?.slug ?? ""}`}
